...
public class sadrelationship extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sadrelationship);
        ...
        mSendFeedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mFeedback.getText().toString().isEmpty()) {
                    Toast.makeText(sadrelationship.this, "Please fill in feedback text box", Toast.LENGTH_LONG).show();
                } else {
                    mFeedback.setText("");
                    mRatingBar.setRating(0);
                    Toast.makeText(sadrelationship.this, "Thank you for sharing your feedback", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mOnInitializedListener =  new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                ...
                youTubePlayer.loadPlaylist("PLpFSp62Ep628_g1X0KczA7S6QsYpxtUov");
