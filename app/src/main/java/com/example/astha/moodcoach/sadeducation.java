...
public class sadeducation extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sadeducation);
        ...
        mSendFeedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mFeedback.getText().toString().isEmpty()) {
                    Toast.makeText(sadeducation.this, "Please fill in feedback text box", Toast.LENGTH_LONG).show();
                } else {
                    mFeedback.setText("");
                    mRatingBar.setRating(0);
                    Toast.makeText(sadeducation.this, "Thank you for sharing your feedback", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mOnInitializedListener =  new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                ...
                youTubePlayer.loadPlaylist("PLVY5-GdAuccI4_nC0rIm0CeWGnr1o1VCg");
